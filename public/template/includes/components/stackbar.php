<div id="stackbar" class="stackbar">	<div class="user_box dark_box clearfix">
	...
	<ul class="">
		<li>
			<a href="#"><img src="template/images/icons/large/grey/computer_imac.png"/><span>Dashboard</span></a>
			<ul>
		...
		<li>
			<a href="#"><img src="template/images/icons/large/grey/mail.png"/><span>Widgets</span><div class="alert_badge alert_green">1</div></a>
			<ul>
		...
		<li>
			<a href="#"><img src="template/images/icons/large/grey/users.png"/><span>Contacts</span><div class="alert_badge alert_blue">2</div></a>
			<ul>
		...
		<li>
			<a href="#"><img src="template/images/icons/large/grey/graph.png"/><span>Reports</span></a>
			<ul>
