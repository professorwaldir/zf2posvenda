<div id="sidebar" class="sidebar pjax_links fixed">
	...
	<div class="user_box dark_box clearfix">
		<img src="template/images/interface/profile.jpg" width="55" alt="Profile Pic" />
		<h2>Administrator</h2>
	...
	<ul class="side_accordion" id="nav_side"> <!-- add class 'open_multiple' to change to from accordion to toggles -->
		<li><a href="layout.php"><img src="template/images/icons/small/grey/laptop.png"/><span>Home</span></a></li>
		<li><a href="layout.php"><img src="template/images/icons/small/grey/frames.png"/><span>Layout</span></a></li>
		<li><a href="#"><img src="template/images/icons/small/grey/list.png"/><span>Base</span></a>
			<ul class="drawer">
		...
		<li><a target="_blank" href="http://twitter.github.com/bootstrap/components.html"><img src="template/images/icons/small/grey/blocks_images.png"/><span>Components</span></a></li>
		<li><a target="_blank" href="http://twitter.github.com/bootstrap/javascript.html"><img src="template/images/icons/small/grey/coverflow.png"/><span>Plugins</span></a></li>
	</ul>
